...
-(void)viewWillAppear:(BOOL)animated{
    ...
    txtComment.attributedPlaceholder = [[NSAttributedString alloc] initWithString:@"Add Comment" attributes:@{NSForegroundColorAttributeName: color}];
...
-(BOOL)validateFields{
    ...
    {
        [self showMessage:@"Please enter comment"];
        return NO;
    }
    return YES;
}
    ...
    [NSURLConnection sendAsynchronousRequest:urlRequest queue:[NSOperationQueue mainQueue] completionHandler:^(NSURLResponse *response, NSData *data, NSError *error)
     {
         ...
         if ([data length] > 0 && error == nil)
         {
             ...
             if(JSONValue!=nil){
                 ...
                 //[photoClass.comment_set insertObject:dictUserInfo atIndex:0];
