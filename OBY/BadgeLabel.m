...
- (void)setStyle:(BadgeLabelStyle)style{
    switch (style) {
        ...
        case BadgeLabelStyleMail:
            self.backgroundColor =[UIColor colorWithRed:214.0f/255 green:0 blue:0 alpha:1]; //[UIColor colorWithRed:142.0f/255 green:156.0f/255 blue:183.0f/255 alpha:1.0];
            self.hasBorder = NO;
            self.hasShadow = NO;
            self.hasGloss = NO;
            self.minWidth = 30.0f;
